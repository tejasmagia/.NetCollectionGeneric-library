...
namespace Tejas
{
    public static class Collection
    {
        ...
        public static T Single<T>(IEnumerable<T> collection, Predicate<T> match)
        {
            ...
            IList<T> list = ToList(Where(collection, match));
            if (list.Count != 1)
            {
        ...
        /// <param name="match"></param>
        /// <returns></returns>
        public static IEnumerable<T> Where<T>(IEnumerable<T> collection, Predicate<T> match)
        {
            if (collection == null)
            {
                throw new ArgumentNullException("collection");
        ...
        public static IEnumerable<T> Intersect<T>(IEnumerable<T> collection1, IEnumerable<T> collection2) where T : IEquatable<T>
        {
            ...
            return Where(collection1, existsInCollection2);
        }
        /// <summary>
